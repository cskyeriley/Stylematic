...
$.mobile.scrollview.prototype._handleDragStart = (function() {
    var origDragStart = $.mobile.scrollview.prototype._handleDragStart;
    return function __handleDragStart() {
        $.util.SetLastMoveTime(); // this is the only new line of code
        origDragStart.apply(this, arguments);
    };
}());

LastMoveTime = 0;
$.util = {}
$.util.SetLastMoveTime = function(){
	LastMoveTime = getCurrentTime();
}

function getCurrentTime() { return (new Date()).getTime(); }

$.util.WasScrolling = function(){
